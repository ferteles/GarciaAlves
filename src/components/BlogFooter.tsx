        ...
        <section className="relative w-full bg-primary pt-24 lg:pt-32 overflow-hidden flex flex-col justify-between">
            <div className="max-w-[1512px] mx-auto w-full px-6 lg:px-20 flex flex-col lg:flex-row justify-between items-start z-10">
                ...
                <form className="flex flex-col md:flex-row w-full max-w-[700px] shadow-sm mt-8 lg:mt-0">
                    <input type="email" placeholder={t.footer_blog.email_placeholder} className="bg-white px-6 py-5 font-motiva font-bold text-black flex-1 outline-none" />
                    <input type="text" placeholder={t.footer_blog.message_placeholder} className="bg-white/90 px-6 py-5 font-motiva font-bold text-black flex-[2] outline-none" />
                    <button type="submit" className="bg-black text-white font-motiva font-bold px-10 py-5 hover:bg-black/80 transition-colors">{t.footer_blog.send}</button>
                </form>
            </div>
