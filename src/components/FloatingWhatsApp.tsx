...
export default function FloatingWhatsApp() {
    ...
    if (!whatsapp || !whatsapp.active || !whatsapp.phoneNumber) {
        return null;
    }

    const encodedMessage = encodeURIComponent(whatsapp.message);
    const whatsappUrl = `https://wa.me/${whatsapp.phoneNumber.replace(/\D/g, '')}?text=${encodedMessage}`;
    ...
    return (
        ...
        >
            {/* Label */}
            <div className={`
                bg-white text-gray-900 px-4 py-2 rounded-full shadow-xl text-sm font-motiva font-bold
            ...
            <a 
                ...
                className="bg-[#25D366] hover:bg-[#128C7E] text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center border border-white/10"
                aria-label="WhatsApp"
            >
                <svg 
                    viewBox="0 0 448 512" 
