  ...
  return (
    <div className="bg-white min-h-screen text-foreground w-full overflow-x-hidden">
      ...
      {data?.show_hero !== false && (
        <section className="relative h-[860px] flex items-center bg-black px-6 lg:px-[123px]">
          <div className="absolute inset-0 z-0 bg-black">
            <img src={heroBgUrl} alt="Hero Background" className="w-full h-full object-cover opacity-[0.6]" />
      ...
      {(data?.show_hero !== false && data?.show_about !== false) && (
